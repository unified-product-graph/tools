...
const ITEMS = [
  { source_id: 'flag1', source_type: 'posthog', title: 'Collaborative editing flag', metadata: { entity_type: 'feature_flag', status: 'running', tags: ['beta'] } },
