...
// The command registry (ALL_COMMANDS) + `commandNames` now live in
// lib/command-registry.ts so cli.ts, the help-safety test, and the help-drift
// guard all iterate one list. Re-export the names probe for backward compat.
export { commandNames }
