...
export const helpTopics: Record<string, HelpEntry> = {
  ...
  tree: {
    ...
    options: [
      FILE_OPT, JSON_OPT,
      { flag: '--pattern <id>', desc: 'Assemble a named tree pattern: ost, okr, user, product, validation, strategy, feature_areas, delivery, architecture, journey, design_system, commercial, north_star' },
